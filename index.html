...
<body class="text-gray-800">
    ...
    <div id="app-container">
        ...
        <div id="main-menu-view" class="view">
                    ...
                    <div class="flex items-center space-x-4">
                         <div class="relative">
                            <button id="notification-bell" class="p-2 rounded-full hover:bg-gray-200 relative">
                                <svg class="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0v1a3 3 0 11-6 0v-1m6 0H9"></path></svg>
            ...
            <main class="container mx-auto px-4 py-8">
                ...
                <div id="go-to-transfers" class="animated-icon p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-shadow cursor-pointer text-center mb-8 flex items-center justify-center">
                    <svg class="w-10 h-10 text-fuchsia-500 mr-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4-4m0 6H4m2 6h2m6-2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                    ...
                    <div id="go-to-kpi" data-permission="canViewKpi" class="animated-icon p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-shadow cursor-pointer">
                        <svg class="w-16 h-16 text-red-500 mx-auto mb-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19l7-7 7-7m-4-4l-4 4m4 4V4m0 18v-3m0 0h-4m4 0h4" /></svg>
        ...
        <div id="check-product-view" class="view">
            <header class="bg-white shadow-sm">
                <div class="container mx-auto px-4 py-4 flex justify-between items-center">
                    <div class="flex items-center space-x-4">
                        ...
                        <h1 class="font-bold text-xl text-gray-800">รอรับสินค้า</h1>
                        <span class="user-display hidden text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded-full"></span>
                    </div>
            ...
            <main class="container mx-auto px-4 py-8">
                <div id="checked-tfor-container" class="space-y-6"></div>
            </main>
        </div>
                ...
                <div id="details-view" class="hidden">
                     <div class="max-w-6xl mx-auto bg-white rounded-3xl shadow-lg p-8 md:p-12">
                        ...
                        <div class="flex flex-col md:flex-row gap-4 mb-6">
                            <input type="search" id="details-search" placeholder="ค้นหา TFOR 4 ตัวท้าย, ทะเบียนรถ, หรือ TFOR พ่วง..." class="w-full p-2 border rounded-lg">
